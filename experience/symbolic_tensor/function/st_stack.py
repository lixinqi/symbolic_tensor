...
def st_stack_forward(tensors: List[torch.Tensor], dim: int = 0) -> torch.Tensor:
    ...
    # Iterate over all coordinates of input shape
    if shape:
...
class StStack(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        ...
        # Return grads for (dim, *tensors) — dim gets None
...
if __name__ == "__main__":
    ...
    # Test 3: dim=1 on 2D — (2,3) x2 → (2, 2, 3)
    ...
    # Test 7: Coefficient preservation
    ...
    # Test 8: Shape mismatch assertion
    ...
    # Test 9: st_stack wrapper (autograd) dim=0
    ...
    # Test 10: st_stack wrapper dim=-1
    ...
    # Test 12: No grad when not required
    ...
    # Test 13: Verify torch.stack parity
